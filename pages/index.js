    ...
    <div className="bg-dusty-green min-h-screen flex justify-center items-center py-8 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-sm sm:max-w-md md:max-w-lg bg-white p-6 sm:p-8 rounded-xl border-3 border-black shadow-lg flex flex-col items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto sm:justify-center">
          ...
          <Link href="/Homepage">
          <button className="bg-green-500 text-black border-2 border-black px-6 py-3 rounded-lg font-bold hover:bg-green-400 transition duration-300 shadow-md">
            explore Collections
          </button>
          </Link>
          
          <button
            className="bg-yellow-400 text-black border-2 border-black px-3 py-3 rounded-lg font-bold hover:bg-yellow-300 transition duration-300 shadow-md"
          >
            Create NFT
          </button>
        </div>
